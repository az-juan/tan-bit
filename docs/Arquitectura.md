...
Decidimos incluir únicamente 'air' y 'atlas' dentro del contenedor y tener 'sqlc' y 'templ' en el host local para reducir el tamaño y el tiempo de compilación inicial de la imagen.
